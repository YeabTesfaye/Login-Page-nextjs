      ...
      <section className="w-3/4  mx-auto flex flex-col gap-10">
        ...
        <form className="flex flex-col gap-5" onSubmit={formik.handleSubmit}>
          ...
          >
            ...
            />
            <span className="icons flex items-center justify-center px-4">
              <HiAtSymbol size={25} />
            </span>
          </div>
          {formik.errors.email && formik.touched.email ? (
          ...
          >
            ...
            />
            <span
              className="icons flex items-center justify-center px-4"
        ...
        {/* bottom */}
        <p className="text-center text-gray-400 pt-0 mt-0 ">
